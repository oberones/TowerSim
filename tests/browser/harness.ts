...
start.addEventListener('click',()=>{
  ...
  if(chooser.value.startsWith('congestion-'))mountGame(root,{state:congestionScenario(chooser.value==='congestion-improved')});
