...
| Stairs versus elevators | Nearest usable stair/elevator entrance for one or two floors, elevators for longer journeys, alternate valid routes when needed; queue length alone does not cause a switch to stairs (FR-017, US4 scenarios 4–6). |
