...
export function topologyChanged(draft:GameState):void {draft.navigation.topologyVersion=add(draft.navigation.topologyVersion,1);buildWalkingSpace(draft);reconcileOfficeAccess(draft);reconcileTopology(draft);}
