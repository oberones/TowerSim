...
export type KernelEvent = EventRecord & ({kind:'dayBoundary'; phasePriority:0} | {kind:'dailyReview'; phasePriority:20} | {kind:'workerArrival';phasePriority:30} | {kind:'customerArrival';phasePriority:30} | {kind:'customerVisitEnd';phasePriority:10} | {kind:'workerDeparture';phasePriority:10} | {kind:'carComplete';phasePriority:40} | {kind:'walkComplete';phasePriority:40});
