...
export const RULESET_ID='tower-offices-v1' as const;
export const CONTENT_VERSION='mvp-offices-v1' as const;
export interface GameState {
  ...
  offices:Record<string,Office>; occupants:Record<string,Occupant>; trips:Record<string,Trip>; officeMarket:{pendingRelease:number};
...
export function createKernelState(input:unknown,seed:string):GameState {
  ...
  return {stateVersion:STATE_VERSION,rulesetId:RULESET_ID,contentVersion:CONTENT_VERSION,scenario,
    ...
    offices:{},occupants:{},trips:{},officeMarket:{pendingRelease:0},
