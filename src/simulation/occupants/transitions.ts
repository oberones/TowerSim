...
const allowed:Record<Occupant['state'],readonly Occupant['state'][]>= {outside:['entering'],entering:['walking','insideFacility','outside','stranded'],walking:['entering'],insideFacility:['entering'],stranded:['entering']};
