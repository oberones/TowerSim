...
export const SCHEDULES=freezeDeep({
  office:{id:'office.workday',arrivalStart:28800,arrivalEnd:29160,departureStart:61200,departureEnd:68400},
  // Daily shares use stratified meal requests; visit duration starts only at physical admission.
