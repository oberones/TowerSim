...
export function createToolbar(scenario:PlayableScenario){
  ...
  node.append(element('p','Offices lease at 06:00 when accessible. Stairs connect adjacent floors; elevators serve a contiguous range. Restaurants arrive later.','muted'));return {node,tools};
}
